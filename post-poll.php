<?php
$pageTitle = "POST Product Survey";
$pageDescription = "Product survey using the POST method";
$pageKeywords = "POST form, product survey, product ranking";
?>
...
<body>
    <div id="container">
        <div class="header">
            ...
            <p class="tagline">POST Product Survey</p>
        </div>

        <div class="content">
            <h2>POST Product Survey</h2>
            ...
            <form action="post-results.php" method="post">
                ...
                <p>
                    <input type="submit" value="Submit POST Survey" />
