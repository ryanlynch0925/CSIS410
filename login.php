...
$pageDescription = "Customer login page for Aunt Lissa's Grace Closet protected organizational chart.";
$pageKeywords = "PHP sessions, login, customer authentication, organizational chart";
$errorMessage = "";
...
<body>
    <div id="container">
        <div class="header">
            ...
            <p class="tagline">Module 4 Sessions Login</p>
        </div>
        ...
        <div class="content">
            ...
            <p>
                Please log in to view the protected organizational chart pages.
            </p>

            <?php
            if ($errorMessage != "") {
                echo "<p class=\"errorMessage\">" . htmlspecialchars($errorMessage, ENT_QUOTES, "UTF-8") . "</p>";
            }
            ?>
            ...
            <p class="highlight">
                Instructor login: username customer, password customer.
            </p>
        </div>
