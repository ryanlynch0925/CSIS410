...
$pageTitle = "Admin Content Management - Grace Bridge Missions";
$pageDescription = "Administrator content management page for Grace Bridge Missions CMS.";
$pageKeywords = "admin, content, CMS, database, Grace Bridge Missions";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["addSection"])) {
    ...
    $displayOrder = trim($_POST["displayOrder"] ?? "0");
    ...
    } elseif (!numbersOnly($displayOrder)) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["deleteSection"])) {
    ...
    if (!numbersOnly($sectionId)) {
        $errorMessage = "The selected content section could not be deleted.";
    } else {
        ...
        $message = "The content section was deleted successfully.";
    }
}

/*
    Pull pages for add form.
*/
...
/*
    Pull existing content sections.
*/
$contentStatement = $pdo->query("
    SELECT
        ...
        content_sections.display_order,
...
<div class="content">
    ...
    <p>
        Administrators can add, update, and delete website content sections stored in the database.
        This supports the CMS requirement for database-driven content management.
    </p>
    ...
    <div class="dashboardBox">
        ...
        <form action="admin_content.php" method="post">
            ...
            <p>
                ...
                <input type="text" name="displayOrder" id="displayOrder" value="0" required />
            </p>
    ...
    <div class="dashboardBox">
        <h3>Edit or Delete Existing Content Sections</h3>
        ...
        ?>
            ...
            <form action="admin_content.php" method="post" class="editForm">
                ...
                <p>
                    ...
                    <select name="sectionType">
                        ...
                        <option value="image" <?php if ($section["section_type"] == "image") echo "selected"; ?>>Image</option>
                ...
                <p>
                    ...
                    <input type="text" name="displayOrder"
                        value="<?php echo cleanOutput($section["display_order"]); ?>" required />
                </p>
                ...
                <p>
                    ...
                    <input type="submit" name="deleteSection" value="Delete Section" />
                </p>
            </form>
